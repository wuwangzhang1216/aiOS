...
def _build_api_prompt(registry: dict) -> str:
    ...
    api_info = {
        ...
        "miniflux": {
            ...
            "token_env": "MINIFLUX_API_TOKEN",
            "auth_prefix": "X-Auth-Token",
            "endpoints": [
                "GET /categories - List categories",
                "POST /categories - Create category: {\"title\":\"x\"}",
                "GET /feeds - List feeds",
                "POST /feeds - Create feed: {\"feed_url\":\"x\",\"category_id\":1}",
                "GET /entries?status=unread - List unread entries",
                "PUT /entries - Update entries: {\"entry_ids\":[1],\"status\":\"read\"}",
            ],
        },
        "vikunja": {
            ...
            "endpoints": [
                ...
                "POST /projects/{id}/tasks - Create task: {\"title\":\"x\",\"description\":\"y\"}",
                "GET /projects/{id}/tasks - List tasks",
                "PUT /tasks/{id} - Update task",
                "GET /labels - List labels",
                "PUT /tasks/{id}/labels - Add label: {\"label_id\":1}",
            ],
        },
        "mattermost": {
            "base_url": "http://localhost:3003/api/v4",
